...
export default function QuotationListScreen({ location, history }) {
    ...
    }, [dispatch, successDelete, userInfo, history, successCreate]);
        ...
        <main>
            ...
            {successCreate && (
                <Modal show={show} onHide={handleClose}>
                    ...
                    <Modal.Body>
                        A copy of this sales quote has been sent to your
                        customer.
                    </Modal.Body>
                    <Modal.Footer>
            ...
            {loading ? (
                ...
                <Table
                    ...
                    striped
                    responsive
                    className='table-sm table-lines'
                >
                    <thead>
                        <tr>
                            <th></th>
